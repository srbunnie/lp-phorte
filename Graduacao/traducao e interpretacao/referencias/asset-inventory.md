# Inventário de materiais — Tradução e Interpretação

## Encontrado no repositório

| Material | Local | Uso |
| --- | --- | --- |
| Curso e nome comercial | `Graduacao/prototipo-pricecard/data/modelo-cursos-ofertas.json` | Nome, id e preço-base |
| Oferta EAD Ao Vivo / Polo Bela Vista | `Graduacao/prototipo-pricecard/data/modelo-cursos-ofertas.json` | Modalidade, polo e disponibilidade |
| Referência visual e estrutural de graduação | `Graduacao/pedagogia/implementacao/elementor/2027-1/` | Padrão de Containers, widgets, CSS e JS |
| Conteúdo editorial sobre tradução e IA | `Cursos-Livres/tradushow.html` | Contexto de mercado; não substituir a copy institucional do curso |
| Briefing e copy-base do curso | `COPYPHORTE_Tradução_2026.08.md` | Fonte editorial principal para proposta, prática, mercado, perfil, docentes, grade e FAQ |
| Componente de preço/inscrição | `Graduacao/prototipo-pricecard/` | Referência de dados e fluxo demonstrativo |

## Mídias oficiais encontradas na página do curso

Estas URLs foram usadas apenas como referência no preview local e no pacote de HTML. Não são downloads nem alterações no WordPress.
